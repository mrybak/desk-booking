...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PersonHourDiscount.name'
        db.add_column(u'booking_personhourdiscount', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)

        # Adding field 'WholeRoomDiscount.name'
        db.add_column(u'booking_wholeroomdiscount', 'name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PersonHourDiscount.name'
        db.delete_column(u'booking_personhourdiscount', 'name')

        # Deleting field 'WholeRoomDiscount.name'
        db.delete_column(u'booking_wholeroomdiscount', 'name')
